...
function openOrganizer(reset=false) {
  ...
  if(reset) {
    ...
    const musicVolume='<fieldset class="music-volume-setting"><legend>'+esc(U.musicVolume)+'</legend><label><input type="range" min="0" max="100" step="1" value="'+volumePercent+'" data-music-volume aria-label="'+esc(U.musicVolume)+'"><output data-music-volume-output>'+volumePercent+'%</output></label></fieldset>';
